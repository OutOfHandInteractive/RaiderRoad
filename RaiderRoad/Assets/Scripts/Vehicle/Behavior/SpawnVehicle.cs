...
public class SpawnVehicle : MonoBehaviour {
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Space))
        {
            ...
            //Debug.Log(types);
            GameObject vehicle = factory.newConstructVehicle(VehicleFactoryManager.vehicleTypes.heavy,3, spawnPoints[numPoints].transform.position);  //3 is the minimum threat for light vehicles - need for construction
